import 'dart:async';
import 'package:koochohealth/blocs/auth/auth.bloc.dart';
...
import 'package:koochohealth/models/datamodel.dart';
      ...
      child: Center(
        child: Column(
          children: <Widget>[
            ...
            Text(
                "Welcome To KoochoHealth,\n\n A central hub for finding find health facilities, managing supply hospital supply chain management, covid testing & vaccinations, appoitnment scheduling between government health officials, health experts & patients",
                style: cBodyText),
            SizedBox(
              width: 10,
              height: 10,
